...
if ( empty($username) ) {
	$username='2408282181';    // <-- change this to your username!
} else {
...
$C->init();
$C->regExp = "|<p class=\"wgtCell_txt\">(.*)</p>(.*)<a href=\"(.*)\" title=\"\" target=\"_blank\" class=\"link_d\">(.*)</a></span>|Uis";
...
?>
     <item>
		<title><?php echo $tcon.'['.$ttime.']'; ?></title>
		<description><![CDATA[<?php echo $tcon.'['.$ttime.']'; ?>]]></description>
		<pubDate><?php echo $ttime; ?></pubDate>
